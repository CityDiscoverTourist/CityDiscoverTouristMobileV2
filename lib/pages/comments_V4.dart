...
class CommentsPageV4 extends StatefulWidget {
  const CommentsPageV4({
    Key? key,
  }) : super(key: key);

  @override
  _CommentsPageV4State createState() => _CommentsPageV4State();
}

class _CommentsPageV4State extends State<CommentsPageV4> {
  ScrollController? controller;
  var myController = Get.find<CommentControllerv4>();
                        ...
                        child:
                          ...
                          itemBuilder: (_, int index) {
                            if (index < myController.dataComment.length) {
                              ...
                              if (myController.lastVisible.value != 0) {
                                return Center(
                                  child: SizedBox(
                                      width: 60.0,
                                      height: 60.0,
