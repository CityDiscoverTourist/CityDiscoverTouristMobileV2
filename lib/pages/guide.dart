...
class _GuidePageState extends State<GuidePage> {
  ...
  Future addMarker() async {
    List m = [
      Marker(
          ...
          position: LatLng(10.845362657418587, 106.79410016682986),
          infoWindow: InfoWindow(title: 'startpoint'),
          icon: BitmapDescriptor.fromBytes(_sourceIcon)),
      Marker(
          markerId: MarkerId('endpoint'),
          position: LatLng(10.844709350072248, 106.7858282343411),
          infoWindow: InfoWindow(title: 'endpoint name'),
  ...
  Future computeDistance() async {
    var p1 = geo.LatLng(10.845362657418587, 106.79410016682986);
    var p2 = geo.LatLng(10.844709350072248, 106.7858282343411);
  ...
  Future _getPolyline() async {
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      Config().mapAPIKey,
      PointLatLng(10.845362657418587, 106.79410016682986),
      PointLatLng(10.844709350072248, 106.7858282343411),
